                ...
                <div class="card">
                    <div class="card-header">
                        <span class="float-left">
                            <h4>Send SMS By Promotion Type</h4>
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-5">
                                ...
                                <form class="form-horizontal" method="POST" action="{{ route('promotion_type.sms.search')}}">
                                    @csrf

                                        <label for="promotion_type">Promotion Type<span style="color:red;">*</span></label>                                                                              
                                        <select name="promotion_type"  class="form-control  mb-2" required>
                                        ...
                                        @endforeach
                                                ...
                                                <div class="mt-4">                                                                                                                          
                                                    <input type="submit" value="Send SMS" class="btn-custom">
