            ...
            <div class="col-md-10 col-lg-12">
                <div class="card">
                    ...
                    <span class="float-left">
                        <h4>Previous Saved Information</h4>
                    </span>
                        <span class="float-right">
                        

                        <a href="{{ route('student.existing.assign_new_type',$student->phone) }}" class="btn btn-primary btn-sm" style="visibility:{{$check}}">Assign new type</a>

                        <a href="{{ route('student.existing.assign_new_course',$student->id) }}" class="btn btn-primary btn-sm">Assign new course</a>
