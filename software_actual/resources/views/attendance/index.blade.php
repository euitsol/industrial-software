                            ...
                            <div class="col-md-6 offset-md-3">
                                    ...
                                    <form action="{{route('attendance.search')}}" method="post">
                                        ...
                                        @if ($errors->has('course'))
                                            <span class="text-danger">{{ $errors->first('course') }}</span><br>
                                        @endif
                                        ...
                                        @if ($errors->has('batch'))
                                            <span class="text-danger">{{ $errors->first('batch') }}</span><br>
                                        @endif
    ...
    <script>
        $(function () {
            ...
            $(document).on('change', '#course_type', function () {
                ...
                if ('' !== course_type) {
                    let _url = "{{route('courses.mentor', ':course_type')}}";
            ...
            $(document).on('change', '#course', function () {
                let course = $(this).val();
                if ('' !== course) {
                    let _url = "{{route('mentor.batches', ':course')}}";
