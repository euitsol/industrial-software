                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-8 offset-md-2">
                                ...
                                <form class="form-horizontal" method="POST" action="{{ route('promotion_type.save') }}" enctype="multipart/form-data">
                                    @csrf
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" class="form-control" id="promotion_type" name = "promotion_type" placeholder="Enter promotion type">
                                        </div>
                                        </div>
                                        <div class="form-group row">
