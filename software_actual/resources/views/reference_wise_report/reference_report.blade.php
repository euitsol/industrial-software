                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="clearfix">
                            ...
                            <p class="float-right">
                                <b>Print Date : </b> {{ date('D d F, Y') }}<br>
                                <b>Query Date : </b> {{ date('D d F, Y', strtotime($from_date)).' - '.date('D d F, Y', strtotime($to_date)) }}
                            </p>
                                ...
                                <table class="table table-bordered">
                                    ...
                                    @foreach ($results as $pk => $result)
                                        ...
                                        <tr>
                                            ...
                                            <td>{{ $result->amount }}</td>
                                            <td>{{ $result->account->get_due($result->id) ?? 0}}</td>
                                        </tr>
                                    @endforeach
                                    </tbody>
                                </table>
