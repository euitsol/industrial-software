                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-borderless">
                                            ...
                                            <tr>
                                                <td>Payable</td>
                                                <td>:</td>
                                                <td>{{ $account->get_due($payment->id) }}.00Tk</td>
                                            </tr>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="form-group mt-1">
            <label for="payment-amount" class = "align-middle">Amount to Pay</label>
            <label></label>
            @if(count($payments)>1)
                <input type="number" class="form-control-file" id="payment-amount" value="{{$account->get_due($payment->id)}}.00" name = "payment_amount" min="{{$account->get_due($payment->id)}}" required>
            @else
                <input type="number" class="form-control-file" id="payment-amount" value="{{$account->get_due($payment->id)}}.00" name = "payment_amount" min="{{$account->get_due($payment->id)/2}}" required>
            @endif
