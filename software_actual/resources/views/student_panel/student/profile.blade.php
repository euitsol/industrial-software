...
@section('content')
                ...
                <div class="card">
                    <div class="card-header d-flex justify-content-between">
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <button type="button" class="btn btn-sm btn-outline-success ml-2" data-toggle="modal"
                                data-target="#StudentCardModal">ID Card</button>
                        </div>
                    </div>
                                                ...
                                                <div class="card-body mb-1">
                                                    <p class="text-center">
                                                        @if (isset($student->photo))
                                                            <img src="{{ asset($student->photo) }}" class="student-photo"
                                                                alt="">
                                                        @else
                                                            @if ($student->gender == 'male')
                                                                <img src="{{ asset('images/avatar-male.jpg') }}"
                                                                    class="student-photo" alt="">
                                                            @else
                                                                <img src="{{ asset('images/avater-female.jpg') }}"
                                                                    class="student-photo" alt="">
                                                            @endif

                                                        @endif
                                                    </p>
                                                    <button type="button" class="btn btn-md btn-outline-info mt-4"
                                                        data-toggle="modal" data-target="#StudentImg">Edit Photo</button>
                                                    ...
                                                    <div class="card-body">
                                                        @if ($student->courses->count() > 0)
                                                            @foreach ($student->courses as $ck => $course)
                                                                <p><i class="fa fa-check-circle"></i> <span> Course Name:
                                                                    </span>
                                                                    {{ $course->title }}
                                                                </p>
                                                                <p><i class="fa fa-check-circle"></i><span> Batch Name:
                                                                    </span>
                                                                    @foreach ($student->batches as $bk => $batch)
                                                                        {{ batch_name($batch->course->title_short_form, $batch->year, $batch->month, $batch->batch_number) }}
                                                                    @endforeach
                                                                </p>
                                                                <p><i class="fa fa-check-circle"></i> <span> Mentor Name:
                                                                    </span>
                                                                ...
                                                                <p><i class="fa fa-check-circle"></i> <span> Total Marks:
                                                                    </span>
                                                                    @foreach ($student->batches as $bk => $batch)
                                                                        @foreach ($minfo as $infos)
                                                                            @foreach ($infos as $info)
                                                                ...
                                                                <p><i class="fa fa-check-circle"></i> <span> Total Class:
                                                                    </span>
                                                                    {{ $course->total_class }}
                                                                </p>
                                                                <p><i class="fa fa-check-circle"></i> <span> Complete Class:
                                                                    </span>
                                                                    @foreach ($student->batches as $bk => $batch)
                                                                        @foreach ($minfo as $infos)
                                                                            @foreach ($infos as $info)
                                                                ...
                                                                <p><i class="fa fa-check-circle"></i> <span> Total Present:
                                                                    </span>
                                                                    @foreach ($student->batches as $bk => $batch)
                                                                        @foreach ($minfo as $infos)
                                                                            @foreach ($infos as $info)
                                                                ...
                                                                <p><i class="fa fa-check-circle"></i> <span> Total Absent:
                                                                    </span>
                                                                    @foreach ($student->batches as $bk => $batch)
                                                                        @foreach ($minfo as $infos)
                                                                            @foreach ($infos as $info)
                                                    ...
                                                    <table class="table table-bordered text-center ">
                                                        ...
                                                        @foreach ($student->batches as $b)
                                                            <tr>
                                                                ...
                                                                <td>{{ batch_name($b->course->title_short_form, $b->year, $b->month, $b->batch_number) }}
                                                                </td>
                                                            </tr>
                                                        @endforeach
                                                    </table>
    ...
    <<<<<<< HEAD <!-- Start Student Image Modal -->
        ...
        <div class="modal fade" id="StudentImg" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle"
            aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                    ...
                    <div class="modal-body text-center">
                        <form enctype="multipart/form-data" action="{{ route('student.profile.photo.update') }}"
                            method="POST" class="avatar-upload">
                            <div class="avatar-edit">
                                <input type="hidden" name="id" value="{{ $student->id }}">
                                <input type='file' id="imageUpload" accept="image/*" name="photo"
                                    class="imageUpload" />
                                @if ($errors->has('photo'))
                                    <span class="text-danger">{{ $errors->first('photo') }}</span>
                                @endif
                            ...
                            @if (isset($student->photo)) {{ asset($student->photo) }}
                            @else

                                @if ($student->gender == 'male')
                                    {{ asset('images/avatar-male.jpg') }}
                                @else
                                    {{ asset('images/avater-female.jpg') }} @endif
                            @endif
                    );">
                                    <input type="hidden" name="_token" value="{{ csrf_token() }}">
                                    <input style="margin-top: 60px;" type="submit" value="Update"
                                        class="btn btn-danger">
                                </div>
                            </div>
                        </form>
                        <div class="modal fade bd-example-modal-lg imagecrop" id="model" tabindex="-1"
                            ...
                            <div class="main_card mb-2 mx-auto">
                                ...
                                <div class="logo_area bg-white">
                                    <div class="id_logo mx-auto">
                                        <img class="img-fluid" src="{{ asset('images/EUITSols Institute New.png') }}"
                                            alt="logo">
                                    </div>
                                ...
                                @else
                                    @if ($student->gender == 'male')
                                        <img src="{{ asset('images/avatar-male.jpg') }}" alt=""
                                            class="profile-pic rounded-circle">
                                    @else
                                        <img src="{{ asset('images/avater-female.jpg') }}" alt=""
                                            class="profile-pic rounded-circle">
                                    @endif
                                @endif
                                <div class="body_area">
                                        ...
                                        <div class="student_details text-left d-flex flex-wrap">
                                            ...
                                            <div class="right_column">
                                                <ul>
                                                    ...
                                                    @foreach ($student->batches as $batch)
                                                        <li><span>:</span>{{ batch_name($batch->course->title_short_form, $batch->year, $batch->month, $batch->batch_number) }}
                                                        </li>
                                                    @endforeach
