                ...
                <div class="card">
                    <div class="card-header">
                        <span class="float-left">
                            ...
                            <a href="{{ route('student.job_placement.edit', $jp->id) }}" class="btn btn-sm btn-info">
                                <i class="fa fa-edit"></i>
                            </a>
                            <a href="{{ route('student.job_placement.info', $jp->student_id) }}" class="btn btn-dark btn-sm">Back</a>
                        </span>
                    </div>
