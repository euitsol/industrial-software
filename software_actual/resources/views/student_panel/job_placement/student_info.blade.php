                            ...
                            <table class="table table-striped">
                                <thead>
                                    <div class="d-flex justify-content-between align-items-center my-4">
                                        ...
                                        @if(!$job_placement)
                                        <a href="{{route('student.job_placement.create', $student->id)}}" class="btn btn-sm btn-info">Add Job Placement</a>
                                        @endif
                                    </div>
                                </thead>
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td style="min-width: 88px;">
                                            <a href="{{ route('student.job_placement.show', $job_placement->id) }}"
                                                class="btn btn-sm btn-dark">
                                                 <i class="fa fa-eye"></i>
                                             </a>
                                            <a href="{{ route('student.job_placement.edit', $job_placement->id) }}"
