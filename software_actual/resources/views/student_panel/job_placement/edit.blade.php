            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <span class="float-right">
                        <a href="{{ route('student.job_placement.info', $jp->student_id) }}" class="btn btn-info btn-sm">Back</a>
                    </span>
                </div>
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-md-8 offset-md-2">
                            <form action="{{ route('student.job_placement.update') }}" method="POST" class="form-horizontal">
                                @csrf
