...
@section('title', 'Student Card - Batch Wise - European IT Solutions Institute')
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-6 offset-md-3">
                                    ...
                                    <form action="{{route('student_card.batch.search')}}" method="post">
                                        @csrf
