                            ...
                            <div class="col-md-8">
                                ...
                                <form action="{{ route('payment.new.receive') }}" method="POST" class="form-horizontal">
                                    ...
                                    <input type="hidden" name="batch_name"
                                        value="{{ batch_name($course->title_short_form, $batch->year, $batch->month, $batch->batch_number) }}">
                                        ...
                                        <div class="col-md-9">
                                            @if ($authCheck)
                                                <label for="discount_yes" class="mr-2">
                                                    <input type="radio" name="discount_radio" id="discount_yes"
                                                        value="yes">
                                                    Yes</label>

                                                <label for="discount_no">
                                                    <input type="radio" name="discount_radio" id="discount_no"
                                            ...
                                            <div class="input-group" id="discount" style="display: none">
                                                ...
                                                <input type="number" name="discount_percent" id="discount_percent"
                                                    value="" min="0" placeholder="Percent"
                                                    class="form-control">

                                                <div class="input-group-append">
                                                    <span class="input-group-text" style="width: 36px !important;">%</span>
                                                </div>

                                                <span class="ml-2 mr-2 mt-2">OR</span>

                                                <input type="number" name="discount_amount" id="discount_amount"
                                                    value="" min="0" placeholder="Amount" class="form-control">
                                            </div>
                                    ...
                                    <div class="form-group row mb-0">
                                        ...
                                        <div class="col-md-9">
                                            ...
                                            <input type="checkbox" name="payment_type[]" id="type_mb"
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9" id="payment_inputs">
                                            <div class="input-group w-50 mt-2" id="cash_container" style="display:none;">
                                                <input placeholder="Cash payment amount" type="number"
                                                    name="cash_payment" id="cash_payment" value=""
                                                    min="0"class="form-control form-control-sm">
                                            </div>
                                            <div class="w-50 mt-2" id="mb_container" style="display:none;">
                                                <select class="form-control form-control-sm" name="mb_type"
                                                    id="mb_type">
                                                ...
                                                <input placeholder="MB payment amount" type="number" name="mb_payment"
                                                    id="mb_payment" value="" min="0"
                                                    class="form-control form-control-sm mt-2">
                                                <input placeholder="Trxn ID Last 6 digits (Uppercase)" type="text"
                                                    name="mb_trxn" id="mb_trxn" value=""
                                                    class="form-control form-control-sm mt-2">
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-md-9">
                                            <div class="input-group w-50">
                                                <input type="number" name="installment_quantity"
                                                    id="installment_quantity" value="" min="0"
                            ...
                            <div class="col-md-4">
                                <table class="table table-borderless border table-striped">
                                    ...
                                    <tr>
                                        <td>Batch</td>
                                        <td>:</td>
                                        <td>{{ batch_name($course->title_short_form, $batch->year, $batch->month, $batch->batch_number) }}
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>Phone</td>
                                    ...
                                    @if (isset($student->photo))
                                        <tr>
                                            <td>Photo</td>
                                            <td>:</td>
                                            <td><img src="{{ asset($student->photo) }}" style="height: 120px;"
                                                    alt="">
                                            </td>
                                        </tr>
                                    @endif
...
@push('js')
    <script>
        ...
        $(document).on('keyup change focusout input', "#discount_percent, #discount_amount, #installment_quantity",
            function() {
                payment_calculation();
            });
        ...
        function installmentDatesGenerate(_total_fee, _total) {
            ...
            if ('' !== installment_quantity_val && installment_quantity_val > 0) {
                ...
                output += '<tr><td rowspan="' + (parseInt(installment_quantity_val) + 1) +
                    '" class="gray">Installment Dates</td></tr>';
                ...
                for (let i = 0; i < parseInt(installment_quantity_val); i++) {
                    output +=
                        '<tr><td><input type="date" name="installment_date[]" class="form-control form-control-sm" value=""></td>';
