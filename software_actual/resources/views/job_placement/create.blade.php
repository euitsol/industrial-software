            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <span class="float-right">
                        <a href="{{ route('job_placement.profile.student.info',$student_id) }}" class="btn btn-info btn-sm">Back</a>
                    </span>
                </div>
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-md-8 offset-md-2">
                            <form action="{{ route('job_placement.store') }}" method="POST" class="form-horizontal">
                                @csrf
