...
@section('title', 'Job Placement - European IT Solutions Institute')
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-8 offset-md-2">
                                <form action="{{ route('job_placement.profile.search') }}" method="POST" class="form-horizontal">
                                    @csrf
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9">
                                            ...
                                            <small>* Student job placement info search by Student Name or Phone Number</small> <br>
